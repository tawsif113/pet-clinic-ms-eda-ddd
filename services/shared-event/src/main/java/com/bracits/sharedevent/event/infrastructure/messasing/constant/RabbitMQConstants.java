package com.bracits.sharedevent.event.infrastructure.messasing.constant;

public class RabbitMQConstants {
  public static final String CUSTOMER_EXCHANGE = "customer.exchange";

  public static final String OWNER_CREATE_COMMAND_QUEUE = "owner.created.command.queue";
  public static final String OWNER_UPDATE_COMMAND_QUEUE = "owner.updated.command.queue";

  public static final String OWNER_CREATE_COMMAND_ROUTING_KEY = "owner.created.command.routing.key";
